            ...
            <div class="row">
                <div class="col-sm-4">
                    <div class="logo pull-left">
                        <a href="{{URL::asset('/trang-chu')}}"><img src="{{asset('public/frontend/images/logo.png')}}" alt="" /></a>
                    </div>
                ...
                <div id="slider-carousel" class="carousel slide" data-ride="carousel">
                    ...
                    <div class="carousel-inner">
                        <div class="item active">
                            ...
                            <div class="col-sm-6">
                                <img src="{{asset('public/frontend/images/pricing.png')}}" class="girl img-responsive" alt="" />
